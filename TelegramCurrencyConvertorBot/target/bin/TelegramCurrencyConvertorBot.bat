...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="TelegramCurrencyConvertorBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" CurrencyBot %CMD_LINE_ARGS%
